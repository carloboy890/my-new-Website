...
function DailyWorkoutCard(props) {
  return (
    <>
      <motion.div
        initial={props.initial}
        style={props.style}
        animate={props.dailyWOControl}
        className="relative w-110"
      >
        <div class="cursor-pointer group bottom-25 scale-130 hover:scale-140 transition-all duration-500 left-80 before:absolute before:bg-sky-500 before:w-3 before:h-12 before:top-15 before:-right-2 before:-z-10 before:rounded-2xl before:shadow-inner before:shadow-gray-50 absolute w-40 h-40 bg-sky-500 shadow-inner shadow-gray-50 flex justify-center items-center rounded-3xl">
          <div class="w-36 rotate-0 h-36 bg-neutral-900 shadow-inner shadow-gray-50 flex justify-center items-center rounded-3xl">
            <div class="flex -rotate-0 flex-col items-center justify-center rounded-2xl bg-neutral-900 shadow-inner shadow-gray-50 w-32 h-32">
              <div class="group-hover:duration-300 hover:opacity-100 opacity-0 before:absolute rotate-0 before:w-12 before:h-12 before:bg-orange-800 before:rounded-full before:blur-xl before:top-16 relative   flex flex-col justify-around items-center w-25 h-22 bg-neutral-900 text-gray-50">
                <span class="">Wed, Sep 19</span>
                <span class="z-10 flex items-center text-5xl text-amber-600 [text-shadow:_2px_2px_#fff,_1px_2px_#fff]">
                  12
              ...
              <span class="text-gray-700 text-lg font-light">Fitness</span>
            </div>
          </div>
        </div>
      </motion.div>
