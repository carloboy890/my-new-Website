  ...
  return (
    <>
      ...
      <div
        ...
        className="left-30 top-50 hover:scale-105 transition duration-300 ease-in-out animate-pulse mt-10 cursor-pointer z-50 absolute h-[180px] w-[180px]
        max-2xl:-ml-0 max-2xl:top-110
        max-xl:-ml-5 
